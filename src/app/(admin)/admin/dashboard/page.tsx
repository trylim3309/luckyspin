    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <StatCard
          ...
          icon={Clock}
          description="Spins in the last 24 hours"
        />
        <StatCard
          title="Total Winners"
        ...
        <StatCard
          ...
          value={stats.totalPrizesClaimed}
          icon={Gift}
          description="Total prizes won"
        />
        <StatCard
          title="Remaining Stock"
          value={stats.totalRemainingStock}
          icon={Gift}
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center ${
                        spin.isWin ? "bg-green-100 text-green-600" : "bg-slate-200 text-slate-600"
                      }`}
                    >
                      {spin.isWin ? "🎉" : "😅"}
                    </div>
